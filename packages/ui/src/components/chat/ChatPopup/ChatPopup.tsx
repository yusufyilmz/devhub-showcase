  ...
  return (
    <div className={className}>
      {!isOpen && (
        <Button
          variant="contained"
          className="bg-button-primary text-textColor-light rounded-lg shadow-2xl relative transition-all duration-300 ease-in-out focus:outline-none transform hover:scale-200"
          onClick={toggleChat}
        >
