...
export const Section: React.FC<PropsWithChildren<SectionProps>> = ({
  ...
  return (
    <>
      ...
      <section
        id={sectionId}
        className={`${className} opacity-0 translate-y-8 transition-all duration-700 animate-fade-in-on-scroll parallax h-section relative w-full flex flex-col items-center justify-start overflow-hidden `}
      >
